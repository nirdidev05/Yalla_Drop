...
object RestaurantContext {
    ...
    val restaurants = listOf(
        Restaurant(
            photoResId = R.drawable.restaurant1,
            name = "Gourmet Haven",
            rating = 4.5f,
            deliveryFee = "Free",
            deliveryTime = "30 min",
        ...
        Restaurant(
            photoResId = R.drawable.restaurant2,
            name = "Sweet Delights",
            rating = 4.8f,
            deliveryFee = "$5",
            deliveryTime = "25 min",
        ...
        Restaurant(
            photoResId = R.drawable.restaurant3,
        ...
        Restaurant(
            photoResId = R.drawable.restaurant4,
            name = "Ocean's Catch",
            rating = 4.0f,
            deliveryFee = "$8",
            deliveryTime = "35 min",
        ...
        Restaurant(
            photoResId = R.drawable.restaurant5,
            name = "Taco Fiesta",
            rating = 4.7f,
            deliveryFee = "$3",
            deliveryTime = "30 min",
        ...
        Restaurant(
            photoResId = R.drawable.restaurant6,
            name = "Vegan Vibes",
            rating = 4.6f,
            deliveryFee = "Free",
            deliveryTime = "25 min",
        ...
        Restaurant(
            photoResId = R.drawable.restaurant7,
            name = "BBQ Kings",
            rating = 4.4f,
            deliveryFee = "$6",
            deliveryTime = "40 min",
        ...
        Restaurant(
            photoResId = R.drawable.restaurant8,
        ...
        Restaurant(
            photoResId = R.drawable.restaurant9,
            name = "Noodle House",
            rating = 4.2f,
            deliveryFee = "$7",
            deliveryTime = "35 min",
        ...
        Restaurant(
            photoResId = R.drawable.restaurant10,
            name = "Sunrise Cafe",
            rating = 4.1f,
            deliveryFee = "$5",
            deliveryTime = "20 min",
