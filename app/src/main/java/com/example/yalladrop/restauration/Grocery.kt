...
fun PromoBanner(navController: NavController) {
    Box(
        ...
        Image(
            painter = painterResource(R.drawable.test_grocery_uno),
...
fun TopBar() {
    Row(
        ...
        Row(
            ...
            ActionIcon(iconId = R.drawable.icon_shoppingcart)
            ActionIcon(iconId = R.drawable.icon_notification)
        }
    }
}
...
val deals = listOf(
    Deal(R.drawable.test_grocery_ariel, "Ariel", 14, 12),
    Deal(R.drawable.test_grocery_fortune, "Fortune", 12, 9),
    Deal(R.drawable.test_grocery_tata, "Tata Salt", 5, 3),
    Deal(R.drawable.test_grocery_biscuit, "Biscuits", 10, 8),
    Deal(R.drawable.test_grocery_the, "The", 15, 12)
)
